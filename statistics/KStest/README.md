...
notebook with missing code: KS_test_solution.ipynb

solution notebook: KS_earthquakes.ipynb

in-class solution to datetime conversion: KS_earthquake_inclass.ipynb

pseudocode to direct the development of the comparison of subsets of data: Corral2018pseudocodeKStest.md
